...
far_detector_spectrum = np.loadtxt('data/output_nu_e_bar.txt') #One extracts the output (WITH THE NOISE)	
ene_FD_article, spec_FD_article = np.array([i[0] for i in far_detector_spectrum]), np.array([i[1] for i in far_detector_spectrum])

fd_spectrum_noise = np.loadtxt('data/output_nu_e_bar_noise.txt') #Noise on the energy distribution of the Nve
ene_FD_art_noise, spec_FD_art_noise = np.array([i[0] for i in fd_spectrum_noise]), np.array([i[1] for i in fd_spectrum_noise])




#One extracts the data of the flux of nu_mu in the nubar_mode

Phi_nu = np.loadtxt('data/Phi_nu_mubar_mode_nubar.txt')
Phi_nu_mu, E = np.array([i[0] for i in Phi_nu]), np.array([i[1] for i in Phi_nu])

plt.plot(E, Phi_nu_mu,'x', color = 'r',label='$\phi_{\overline{\u03BD_{\mu}}}^{ND}$') #One plot the data of the nu_mu flux
plt.title('Input data smoothing')

plt.yscale('log')
plt.xlabel('E GeV')
plt.ylabel('$\phi_{\overline{\u03BD_{\mu}}}^{ND}$    ${\overline{\u03BD_{\mu}}}$/$cm^{2}$/POT/1 GeV')
plt.legend()
...
plt.bar(E_lisseND,Phi_lisseND,color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin,label='$\phi_{\overline{\u03BD_{\mu}}}^{ND}$')
plt.yscale('log')
plt.legend()
plt.show()
plt.close()
...
plt.subplot(311)
plt.title('Effect of P$_{\overline{\u03BD_{\mu}} -> \overline{\u03BD_e}}$')

plt.bar(E_lisseND,Phi_lisseND,color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin,label='$\phi_{\overline{\u03BD_{\mu}}}^{ND}$') #Plot Input data
plt.xlabel('E GeV')
plt.ylabel('$\phi_{\overline{\u03BD_{\mu}}}^{ND}$    ${\overline{\u03BD_{\mu}}}$/$cm^{2}$/POT/1 GeV')
plt.legend()
...
plt.subplot(312)
plt.plot( Ex, osc_mod.probability_oscillation( theta12 , theta13 , theta23, Ex, 1285 ,0, True, False),label='P$_{\overline{\u03BD_{\mu}} -> \overline{\u03BD_e}}$')
plt.xlabel('E GeV')
plt.ylabel('P$_{\overline{\u03BD_{\mu}} -> \overline{\u03BD_e}}$')
plt.legend()
...
Phi_mue_FD = Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23,E_lisseND, 1285 ,0, True, False)
plt.bar(E_lisseND,Phi_mue_FD,color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin,label='$\phi_{\overline{\u03BD_{\mu}}}^{ND}$ x P$_{\overline{\u03BD_{\mu}} -> \overline{\u03BD_e}}$') #Plot du spectre au FD th

plt.xlabel('E GeV')
plt.ylabel('$\phi_{\overline{\u03BD_{\mu}}}^{ND}$ x P$_{\overline{\u03BD_{\mu}} -> \overline{\u03BD_e}}$   ${\overline{\u03BD_e}}$/$cm^{2}$/POT/1 GeV')
...
plt.xlabel('E GeV')
plt.ylabel('$\phi_{\overline{\u03BD_{\mu}}}^{FD}$ / $\phi_{\overline{\u03BD_{\mu}}}^{ND}$')
plt.xlim(0.25,Emax)
#print(E_lisseND)
...
plt.bar(E_lisseND, Phi_lisseND ,color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin , label = '$\phi_{\overline{\u03BD_{\mu}}}^{ND}$')
plt.xlabel('E GeV')
plt.ylabel('$\phi_{\overline{\u03BD_{\mu}}}^{ND}$   ${\overline{\u03BD_{\mu}}}$/$cm^{2}$/POT/1GeV')
plt.legend()



plt.subplot(223) # Ph_nu_mu_ND x F
plt.bar(E_lisseND, Phi_lisseND * F_lisse,color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin , label = '$\phi_{\overline{\u03BD_{\mu}}}^{ND}$ x F')
plt.xlabel('E GeV')
plt.ylabel('$\phi_{\overline{\u03BD_{\mu}}}^{ND}$ x F')
plt.legend()


plt.subplot(222) # Ph_nu_mu_ND x Papp

plt.bar(E_lisseND,Phi_mue_FD,color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin ,label='$\phi_{\overline{\u03BD_{\mu}}}^{ND}$ x P$_{\overline{\u03BD_{\mu}} -> \overline{\u03BD_e}}$') #One has now nu_e/cm^2 per 1GeV
plt.xlabel('E GeV')
plt.ylabel('$\phi_{\overline{\u03BD_{\mu}}}^{ND}$xP$_{\overline{\u03BD_{\mu}} -> \overline{\u03BD_e}}$xF   ${\overline{\u03BD_e}}$/$cm^{2}$/POT/1GeV')
plt.legend()

plt.subplot(224) # Ph_nu_mu_ND x Papp x F

Phi_mue_det_FD = Phi_mue_FD * F_lisse
plt.bar(E_lisseND,Phi_mue_det_FD,color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin ,label='$\phi_{\overline{\u03BD_{\mu}}}^{ND}$ x P$_{\overline{\u03BD_{\mu}} -> \overline{\u03BD_e}}$ x F') #One has now nu_e/cm^2 per 1GeV
plt.xlabel('E GeV')
plt.ylabel('$\phi_{\overline{\u03BD_{\mu}}}^{ND}$xP$_{\overline{\u03BD_{\mu}} -> \overline{\u03BD_e}}$xF')
plt.legend()
...
log10E, sigma_o_E_nuebar_data = np.array([i[0] for i in sigma_o_E]), np.array([i[4] for i in sigma_o_E])*1e-38
E = pow( 10 , log10E)
sigma_o_E_nuebar_interp = interp1d(E, sigma_o_E_nuebar_data, kind='cubic')
sigma_nuebar = np.array(sigma_o_E_nuebar_interp(E_lisseND)) * E_lisseND 
...
sigma_FD = m_Ar_FD * Na/M_Ar * N_nuc_per_Ar * sigma_nuebar #cross section of the reaction ( nu_e + n -> e- + p ) in the FD (in cm^2)

plt.subplot(211)
plt.title('Comparison of $\phi_{\overline{\u03BD_{\mu}}}^{ND}$ * P$_{\overline{\u03BD_{\mu}} -> \overline{\u03BD_e}}$ * F * $\sigma_{\overline{\u03BD_e}}^{Ar}$   vs   N$_{\overline{\u03BD_e}}^{FD}$')
plt.plot(E, m_Ar_FD * Na/M_Ar * N_nuc_per_Ar * sigma_o_E_nuebar_data * E, 'x', label='$\sigma_{\overline{\u03BD_e}}^{Ar}$  data')
plt.bar(E_lisseND, sigma_FD,color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin,label='$\sigma_{\overline{\u03BD_e}}^{Ar}$  smoothed')
plt.legend()
plt.xlabel('E GeV')
plt.xlim(0,10)
plt.ylim(0,0.001)
plt.ylabel('$\sigma_{\overline{\u03BD_e}}^{Ar}$   cm^2')
...
plt.bar(E_lisseND,N_mue_det * Npot,color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin,label='$\phi_{\overline{\u03BD_{\mu}}}^{ND}$ * P$_{\overline{\u03BD_{\mu}} -> \overline{\u03BD_e}}$ * F * $\sigma_{\overline{\u03BD_e}}^{Ar}$') #One has now nu_e per 1GeV

plt.xlabel('E GeV')
plt.ylabel('N$_{\overline{\u03BD_e}}^{FD}$   ${\overline{\u03BD_e}}$/1GeV (x1.1*10$^{21}$POT)')


plt.plot(ene_FD_article, np.array(spec_FD_article),'x',color='red', label='N$_{\overline{\u03BD_e}}^{FD-data}$')
plt.legend()
...
plt.bar(E_lisseND , np.array(osc_mod.Rec2(Acc, E_lisseND, N_mue_det * Npot * Nmultiply , bias)) / Nmultiply,color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin,label='$\phi_{\overline{\u03BD_{\mu}}}^{ND}$ * P$_{\overline{\u03BD_{\mu}}} -> \overline{\u03BD_{e}}$ * F * $\sigma_{\overline{\u03BD_e}}^{Ar}$ *T with Rec2')	

plt.plot(ene_FD_article, np.array(spec_FD_article)/max(np.array(spec_FD_article))*max(np.array(osc_mod.Rec2(Acc, E_lisseND, N_mue_det * Npot , bias))),'x',color='red', label='N$_{\overline{\u03BD_e}}^{FD-data}$')
#plt.plot(ene_FD_article, np.array(spec_FD_article) ,'x',color='red', label='N$_{\overline{\u03BD_e}^{FD-data}$')
plt.ylabel('N$_{\overline{\u03BD_e}}^{FD}$   ${\overline{\u03BD_e}}$/1GeV (x1.1*10$^{21}$POT)')
plt.xlabel('E GeV')
plt.legend()
...
plt.title('Normalization of N$_{\overline{\u03BD_e}}^{FD-th}$ by the max ratio')

##plt.plot(ene_FD_article, np.array(spec_FD_article)/max(np.array(spec_FD_article))*max(np.array(osc_mod.Rec2(Acc, E_lisseND, N_mue_det * Npot * Nmultiply )) / Nmultiply),'x',color='red', label='N$_{\overline{\u03BD_e}^{FD-data}$')
...
plt.subplot(211)
plt.plot(ene_FD_article, np.array(spec_FD_article),'x',color='red', label='N$_{\overline{\u03BD_e}}^{FD-data}$ with noise') #Output data
plt.plot(ene_FD_art_noise, spec_FD_art_noise, 'x', color='blue', label='Noise') #Noise data
...
plt.bar(E_lisseND, N_FD_hist , color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin , label = 'N$_{\overline{\u03BD_e}}^{FD-data}$ smoothed without noise') #Output smoothed data
plt.legend()
plt.show()
plt.close()
...
plt.subplot(331) # deltaCP_1 ;theta23_1 

N_1 = np.array(osc_mod.Rec2(Acc, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23_1 ,E_lisseND, 1285 ,deltaCP_1*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply
...
plt.plot(E_lisseND, N_FD_hist ,'x',color='red', label='N$_{\overline{\u03BD_e}}^{FD-data}$')
plt.errorbar(E_lisseND, N_FD_hist, DN_nu_e, fmt='none',ecolor ='blue')
plt.ylabel('$\delta_{CP}= -0.45 $')
plt.legend()

plt.subplot(332) # deltaCP_1 ;theta23_2 
plt.title('N$_{\overline{\u03BD_e}}^{FD}$   ${\overline{\u03BD_e}}$/1GeV (x1.1*10$^{21}$POT)')
N_2 = np.array(osc_mod.Rec2(Acc, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23_2,E_lisseND, 1285 ,deltaCP_1*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply
...
plt.subplot(333) # deltaCP_1 ;theta23_3

N_3 = np.array(osc_mod.Rec2(Acc, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23_3 ,E_lisseND, 1285 ,deltaCP_1*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply
...
plt.subplot(334) # deltaCP_2 ;theta23_1 

N_4 = np.array(osc_mod.Rec2(Acc, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23_1 ,E_lisseND, 1285 ,deltaCP_2*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply
...
plt.subplot(335) # deltaCP_2 ;theta23_2 

N_5 = np.array(osc_mod.Rec2(Acc, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23_2 ,E_lisseND, 1285 ,deltaCP_2*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply
...
plt.subplot(336) # deltaCP_2 ;theta23_3

N_6 = np.array(osc_mod.Rec2(Acc, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23_3 ,E_lisseND, 1285 ,deltaCP_2*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply
...
plt.subplot(337) # deltaCP_3 ;theta23_1 

N_7 = np.array(osc_mod.Rec2(Acc, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23_1 ,E_lisseND, 1285 ,deltaCP_3*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply
...
plt.ylabel('$\delta_{CP}= 2.65 (min value)$')
plt.legend()

plt.subplot(338) # deltaCP_3 ;theta23_2 

N_8 = np.array(osc_mod.Rec2(Acc, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23_2 ,E_lisseND, 1285 ,deltaCP_3*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply
...
plt.plot(E_lisseND, N_FD_hist ,'x',color='red', label='N$_{\overline{\u03BD_e}}^{FD-data}$')
plt.errorbar(E_lisseND, N_FD_hist, DN_nu_e, fmt='none',ecolor ='blue')
plt.xlabel('$\Theta_{23} = 0.87 (true value) rad$')
plt.legend()

plt.subplot(339) # deltaCP_3 ;theta23_3 

N_9 = np.array(osc_mod.Rec2(Acc, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23_3 ,E_lisseND, 1285 ,deltaCP_3*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply
...
plt.plot(E_lisseND, N_FD_hist ,'x',color='red', label='N$_{\overline{\u03BD_e}}^{FD-data}$')
plt.errorbar(E_lisseND, N_FD_hist, DN_nu_e, fmt='none',ecolor ='blue')
plt.xlabel('$\Theta_{23} = 0.94 rad$  (min value)')
plt.legend()
...
for i in range (0,len(delta_CP)):
	L_Papp = L_Papp + [osc_mod.probability_oscillation(theta12 , theta13 , theta23, E_lisseND, 1285 ,delta_CP[i]*180/np.pi, True, False)]
	
	
	L_N_nue = L_N_nue + [ np.array(osc_mod.Rec2(Acc, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23,E_lisseND, 1285 ,delta_CP[i]*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply ]
...
#plt.bar(E_lisseND , L_N_nue[75] ,color='grey',edgecolor = 'black',width=(7-0.5)/Nbin,label='$\phi_{\overline{\u03BD_{\mu}}^{ND}$ * P$_{\overline{\u03BD_{\mu} -> \overline{\u03BD_e}$ * F * $\sigma_{\overline{\u03BD_e}^{Ar}$ *T')
...
for i in range (0,len(L_theta23)):
	L_Papp = L_Papp + [osc_mod.probability_oscillation(theta12 , theta13 , L_theta23[i], E_lisseND, 1285 ,0*180/np.pi, True, False)]
	
	
	L_N_nue = L_N_nue + [ np.array(osc_mod.Rec2(Acc, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , L_theta23[i],E_lisseND, 1285 ,0*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply ]
...
"""
L_deltaCP_o_pi = np.linspace (-1,1,200) 
L_theta23 = np.linspace(0.3,1.3,200)
...
for i in range (0,len(L_theta23)):
	...
	for j in range (0,len(L_deltaCP_o_pi)) :
		LL2_N_nue[i] = LL2_N_nue[i] + [np.array(osc_mod.Rec2( Acc,E_lisseND, Phi_lisseND * osc_mod.probability_oscillation_v2(osc_par.delta_m31, osc_par.delta_m32 ,theta12 , theta13, L_theta23[i], E_lisseND, 1285 ,L_deltaCP_o_pi[j]*np.pi*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply , bias))/Nmultiply]
...
L_accuracy = np.linspace(10,35,70)
L_N_nue = []
...
for i in range (0,len(L_accuracy)):
	...
	L_N_nue = L_N_nue + [ np.array(osc_mod.Rec2(L_accuracy[i], E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( osc_par.theta12 , osc_par.theta13 , osc_par.theta23,E_lisseND, 1285 ,0*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply ]
...
N_1 = np.array(osc_mod.Rec2(Acc_1, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23_min_acc1 ,E_lisseND, 1285 ,deltaCP_min_acc1*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply
chi2_1 = osc_mod.chi2( N_1 , N_FD_hist , E_lisseND)
chi2_str_1=str(round(chi2_1,2))
plt.bar(E_lisseND , N_1 ,color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin,label=(f"$\chi^2$={chi2_str_1}"))
plt.plot(E_lisseND, N_FD_hist ,'x',color='red', label='N$_{\overline{\u03BD_e}^{FD-data}$')
...
N_1 = np.array(osc_mod.Rec2(Acc_1, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23 ,E_lisseND, 1285 ,0*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply
chi2_1 = osc_mod.chi2( N_1 , N_FD_hist , E_lisseND)
chi2_str_1=str(round(chi2_1,2))
plt.bar( E_lisseND , N_1,color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin,label=(f"$\chi^2$={chi2_str_1}"))
plt.plot(E_lisseND, N_FD_hist ,'x',color='red', label='N$_{\overline{\u03BD_e}^{FD-data}$')
...
N_3 = np.array(osc_mod.Rec2(Acc_2, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23_min_acc2 ,E_lisseND, 1285 ,deltaCP_min_acc2*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply
chi2_3 = osc_mod.chi2( N_3 , N_FD_hist , E_lisseND)
chi2_str_3=str(round(chi2_3,2))
plt.bar(E_lisseND , N_3 ,color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin,label=(f"$\chi^2$={chi2_str_3}"))
plt.plot(E_lisseND, N_FD_hist ,'x',color='red', label='N$_{\overline{\u03BD_e}^{FD-data}$')
...
N_4 = np.array(osc_mod.Rec2(Acc_2, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23 ,E_lisseND, 1285 ,0*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply
chi2_4 = osc_mod.chi2( N_4 , N_FD_hist , E_lisseND)
chi2_str_4=str(round(chi2_4,2))
plt.bar( E_lisseND , N_4,color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin,label=(f"$\chi^2$={chi2_str_4}"))
plt.plot(E_lisseND, N_FD_hist ,'x',color='red', label='N$_{\overline{\u03BD_e}^{FD-data}$')
...
N_5 = np.array(osc_mod.Rec2(Acc_3, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23_min_acc3 ,E_lisseND, 1285 ,deltaCP_min_acc3*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply
chi2_5 = osc_mod.chi2( N_5 , N_FD_hist , E_lisseND)
chi2_str_5=str(round(chi2_5,2))
plt.bar(E_lisseND , N_5 ,color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin,label=(f"$\chi^2$={chi2_str_5}"))
plt.plot(E_lisseND, N_FD_hist ,'x',color='red', label='N$_{\overline{\u03BD_e}^{FD-data}$')
...
N_6 = np.array(osc_mod.Rec2(Acc_3, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation( theta12 , theta13 , theta23 ,E_lisseND, 1285 ,0*180/np.pi, True, False) * F_lisse * sigma_FD * Npot *Nmultiply ,bias))/Nmultiply
chi2_6 = osc_mod.chi2( N_6 , N_FD_hist , E_lisseND)
chi2_str_6=str(round(chi2_6,2))
plt.bar( E_lisseND , N_6,color='grey',edgecolor = 'black',width=(Emax-0.5)/Nbin,label=(f"$\chi^2$={chi2_str_6}"))
plt.plot(E_lisseND, N_FD_hist ,'x',color='red', label='N$_{\overline{\u03BD_e}^{FD-data}$')
...
for i in range (0,len(Lbias)):
	...
	L_N_nue = L_N_nue + [ np.array(osc_mod.Rec2(Acc, E_lisseND, Phi_lisseND * osc_mod.probability_oscillation ( theta12 , theta13 , theta23 ,E_lisseND, 1285 ,0*180/np.pi, True, False )  * F_lisse * sigma_FD * Npot *Nmultiply , Lbias[i]))/Nmultiply ]
...
L_bias = np.linspace(-20,20,80)
L_Reco= np.linspace(5,50,80)
LL2_N_nue = []
L2_khi2 = []
...
for i in range (0,len(L_bias)):
	...
	for j in range (0,len(L_Reco)) :
		LL2_N_nue[i] = LL2_N_nue[i] + [np.array(osc_mod.Rec2(L_Reco[j], E_lisseND, Phi_lisseND * osc_mod.probability_oscillation ( theta12 , theta13 , theta23 ,E_lisseND, 1285 ,0*180/np.pi, True, False )  * F_lisse * sigma_FD * Npot *Nmultiply , L_bias[i]))/Nmultiply]
